...
def test_key_manager():
    ...
    print("\n5. Testing key manager functionality...")
...
def test_model_manager():
    ...
    print("\n6. Testing dynamic model manager functionality...")
...
def test_enhanced_agent():
    ...
    print("\n7. Testing DuckGrade core engine...")
...
def main():
    ...
    if passed == total:
        ...
        print("\n🚀 To get started:")
        print("• Run: start_local_gui.bat (Local file grading)")
        print("• Or:  start_canvas_gui.bat (Canvas integration)")
        print("\n📊 Pricing Information:")
